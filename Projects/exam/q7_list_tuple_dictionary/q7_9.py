...
# 좌석을 예약하시겠습니까( 1(Y) 또는 0(N) )?  1 현재의 예약 상태는 다음과 같습니다.
# ---------------------------------------- 
...
while True:
    q9_input= input('좌석을 예약하시겠습니까( 1(Y) 또는 0(N) )?: ')
    if q9_input == '0' or q9_input.lower() == 'n':
        print('예약을 종료합니다.')
        break
    ...
    while True:
        ...
        if seat[seat_num-1] == 1:
            print('죄송합니다. 이미 예약된 자리입니다.')
        else:
            break
    seat[seat_num-1]=1
    print(f'{seat_num}좌석이 예약되었습니다.')
